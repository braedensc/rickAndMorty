...
interface Props {
    // updates the global characterFilter by combining each indiviidual Filter's query into an array
    // filterId is the index of that specific filter's query in the overall array, used to help keep track of which filter made which request
...
const CharacterFilter: React.FC<Props> = ({onSelect, characterQuery = [], resultCountByFilter = []}) => {
    ...
    // 4 filters for big screen, 2 for small screen
